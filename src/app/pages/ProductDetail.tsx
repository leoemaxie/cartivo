...
import { ChevronLeft, Star, Heart, Share2, Camera, ShoppingBag, Sparkles, MessageSquare, Info, ShieldCheck, Truck } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row min-h-screen lg:pt-8">
        ...
        <div className="lg:w-1/2 p-6 md:p-12 space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <button className="flex-1 bg-slate-900 text-white py-5 rounded-3xl font-bold text-lg flex items-center justify-center gap-3 hover:bg-slate-800 shadow-xl transition-all">
